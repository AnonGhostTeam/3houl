...
#Fancy banner :p
print ('''\033[1;34m____ _  _ ____ _  _ _    
| __ |__| |  | |  | |    
|__] |  | |__| |__| |___ 
                         
                          \033[37mGhoul \033[91m|\033[37m AnonGhost\033[1;m''')

print ('''\n  To hack a system requires getting to know its rules better than the people who created it or are running it,
and exploiting all the vulnerable distance between how those people had intended the system to work and how it actually works,
